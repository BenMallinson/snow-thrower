...
class App extends Component {
  render() {
    ...
    return (
      <div className="App">
        <a-scene fog="type: exponential; color: #AAA" vr-mode-ui="enabled: true" physics="debug: true;">
          <a-assets>
          ...
          <a-box static-body name="chimney" class="clickable" className="box" color="orange" scale="0.5 2 0.5" position="-3 4 -14.5" targetable="distance: 160;" />
          <a-box static-body name="house" color="red" scale="5 5 5" position="-4 0.5 -16"/>
          <a-box static-body name="chimney" class="clickable" className="box" color="yellow" scale="1 2 1" position="5 5.5 16.5" targetable="distance: 160;" />
